...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mithril/mithril.mjs":[function(require,module,exports) {
...
var options = ['/posts', '/comments', '/albums', '/photos', '/todos', '/users'];

var url = function url(item) {
  return function (start, limit) {
    return "https://jsonplaceholder.typicode.com".concat(item, "?_start=").concat(start, "&_limit=").concat(limit);
  };
};

var urls = options.reduce(function (req, item) {
  req[item] = url(item);
  return req;
}, {});

var http = function http(model) {
  return function (url) {
...
var model = {
  ...
  toggleLimits: function toggleLimits(model) {
    return model.state.showLimits = !model.state.showLimits;
  },
  showTabs: function showTabs(model) {
    return model.state.tabsShowing = !model.state.tabsShowing;
  }
};
exports.model = model;
},{"mithril":"node_modules/mithril/mithril.mjs"}],"src/components/Hamburger.js":[function(require,module,exports) {
"use strict";
  ...
  return {
    ...
    view: function view(_ref4) {
      ...
      return (0, _mithril.default)('svg.btn.hamburger', {
        style: {
          fill: model.state.tabsShowing ? 'white' : 'inherit'
        },
        onclick: function onclick() {
          return model.showTabs(model);
        }
      });
    }
  };
...
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs"}],"src/utils/animations.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.animateChildrenLimitsExit = exports.slideModalOut = exports.animate = exports.animateChildrenLimitsEntrance = exports.animateChildrenEntrance = exports.animateSidebarEntrance = exports.animateComponentEntrance = void 0;
...
var Selector = {
  ...
  view: function view(_ref) {
    var model = _ref.attrs.model;
    return (0, _mithril.default)('.limits', model.limits.map(function (limit, idx) {
...
var ChangeLimits = {
  view: function view(_ref2) {
    ...
    return (0, _mithril.default)('.changeLimits', [(0, _mithril.default)('button.changeLimitBtn', {
      onclick: function onclick() {
        return model.toggleLimits(model);
      }
    }, 'Change Limit'), model.state.showLimits && (0, _mithril.default)(Selector, {
      model: model
    })]);
  }
};
var Header = {
  oncreate: (0, _animations.animate)('slideDown'),
  view: function view(_ref3) {
    ...
    return (0, _mithril.default)('header.header', {
      ...
      model: model
    }), (0, _mithril.default)(ChangeLimits, {
      model: model
    })]);
  }
};
var _default = Header;
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","./Hamburger.js":"src/components/Hamburger.js","../utils/animations.js":"src/utils/animations.js"}],"src/components/Footer.js":[function(require,module,exports) {
"use strict";
...
var Footer = {
  oncreate: (0, _animations.animate)('slideUp'),
  view: function view() {
    return (0, _mithril.default)('footer.footer', {
      oncreate: _animations.animateChildrenLimitsEntrance,
      id: 'footer'
...
var _default = Footer;
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","../utils/animations.js":"src/utils/animations.js"}],"src/components/Sidebar.js":[function(require,module,exports) {
"use strict";
...
var Sidebar = function Sidebar(_ref3) {
  var model = _ref3.attrs.model;
  var tabs = Object.keys(model.reqs.urls);
  return {
    oncreate: _animations.animateSidebarEntrance,
    view: function view(_ref4) {
      var model = _ref4.attrs.model;
      return (0, _mithril.default)('aside.sidebar slide-left', {
        id: 'sidebar'
...
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","../utils/animations.js":"src/utils/animations.js"}],"src/components/Modal.js":[function(require,module,exports) {
"use strict";
...
var _default = Modal;
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","../utils/animations.js":"src/utils/animations.js"}],"src/components/Body.js":[function(require,module,exports) {
"use strict";
...
var Body = {
  oncreate: (0, _animations.animate)('slideUp'),
  view: function view(_ref) {
    var children = _ref.attrs.children;
...
var _default = Body;
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","../utils/animations.js":"src/utils/animations.js"}],"src/components/Layout.js":[function(require,module,exports) {
"use strict";
  ...
  return {
    view: function view(_ref2) {
      ...
      return (0, _mithril.default)('section.layout', {
        ...
        model: model
      }), model.state.profile == 'phone' ? model.state.tabsShowing ? (0, _mithril.default)(_Modal.default, (0, _mithril.default)(_Sidebar.default, {
        model: model
      })) : null : (0, _mithril.default)(_Sidebar.default, {
        model: model
...
var _default = Layout;
exports.default = _default;
},{"mithril":"node_modules/mithril/mithril.mjs","./Header.js":"src/components/Header.js","./Footer.js":"src/components/Footer.js","./Sidebar.js":"src/components/Sidebar.js","./Modal.js":"src/components/Modal.js","./Body.js":"src/components/Body.js"}],"src/utils/helpers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.init = exports.infiniteScroll = exports.getData = exports.isEmpty = void 0;
...
var getData = function getData(model) {
  return function (path) {
    ...
    var start = model.data[path].data.length;
...
var infiniteScroll = function infiniteScroll(model) {
  return function (e) {
    var route = model.state.route;
    var length = model.data[route].data.length;
    var setpoint = 10 * length * model.state.scrollPos;
...
},{"./animations.js":"src/utils/animations.js","./helpers.js":"src/utils/helpers.js"}],"src/App.js":[function(require,module,exports) {
"use strict";
...
var Post = {
  view: function view(_ref) {
    var _ref$attrs = _ref.attrs,
        key = _ref$attrs.key,
        _ref$attrs$item = _ref$attrs.item,
        title = _ref$attrs$item.title,
        body = _ref$attrs$item.body;
    return (0, _mithril.default)('.grid-item.row.post', {
      id: "post-".concat(key)
    }, [(0, _mithril.default)('h1.left', title), (0, _mithril.default)('p.right', body)]);
  }
};
var Comment = {
  view: function view(_ref2) {
    var _ref2$attrs = _ref2.attrs,
        key = _ref2$attrs.key,
        _ref2$attrs$item = _ref2$attrs.item,
        email = _ref2$attrs$item.email,
        name = _ref2$attrs$item.name,
        body = _ref2$attrs$item.body;
    return (0, _mithril.default)('.grid-item.row.comment', {
      id: "comment-".concat(key)
    }, [(0, _mithril.default)('h1.left', name), (0, _mithril.default)('p.left', email), (0, _mithril.default)('p.left', body)]);
  }
};
var Album = {
  view: function view(_ref3) {
    var _ref3$attrs = _ref3.attrs,
        key = _ref3$attrs.key,
        title = _ref3$attrs.item.title;
    return (0, _mithril.default)('.grid-item.album', {
      id: "album-".concat(key)
    }, [(0, _mithril.default)('h1', title)]);
  }
};
var Photo = {
  view: function view(_ref4) {
    var _ref4$attrs = _ref4.attrs,
        key = _ref4$attrs.key,
        _ref4$attrs$item = _ref4$attrs.item,
        title = _ref4$attrs$item.title,
        thumbnailUrl = _ref4$attrs$item.thumbnailUrl;
    return (0, _mithril.default)('.grid-item.photo', {
      id: "photo-".concat(key)
    }, [(0, _mithril.default)('h1.left', title), (0, _mithril.default)('img.right', {
      src: thumbnailUrl
    })]);
  }
};

var Todo = function Todo(_ref5) {
  var completed = _ref5.attrs.item.completed;
  return {
    view: function view(_ref6) {
      var _ref6$attrs = _ref6.attrs,
          key = _ref6$attrs.key,
          title = _ref6$attrs.item.title;
      return (0, _mithril.default)('.grid-item.todo', {
        id: "todo-".concat(key),
        key: key
      }, [(0, _mithril.default)('h1.left', title), (0, _mithril.default)('input[type=checkbox].right', {
        onclick: function onclick() {
          completed = !completed;
        },
        checked: completed
...
var User = {
  view: function view(_ref7) {
    var _ref7$attrs = _ref7.attrs,
        key = _ref7$attrs.key,
        _ref7$attrs$item = _ref7$attrs.item,
        email = _ref7$attrs$item.email,
        name = _ref7$attrs$item.name,
        phone = _ref7$attrs$item.phone,
        username = _ref7$attrs$item.username,
        website = _ref7$attrs$item.website;
    return (0, _mithril.default)('.grid-item.user', {
      id: "user-".concat(key),
      key: key
    }, [(0, _mithril.default)('.row', [(0, _mithril.default)('p.left', {
      for: 'name'
    }, 'name'), (0, _mithril.default)('p.right.bold', {
      name: 'name'
    }, name)]), (0, _mithril.default)('.row', [(0, _mithril.default)('p.left', {
      for: 'email'
    }, 'email'), (0, _mithril.default)('p.right.bold', {
      name: 'email'
    }, email)]), (0, _mithril.default)('.row', [(0, _mithril.default)('p.left', {
      for: 'phone'
    }, 'phone'), (0, _mithril.default)('p.right.bold', {
      name: 'phone'
    }, phone)]), (0, _mithril.default)('.row', [(0, _mithril.default)('p.left', {
      for: 'username'
    }, 'username'), (0, _mithril.default)('p.right.bold', {
      name: 'username'
    }, username)]), (0, _mithril.default)('.row', [(0, _mithril.default)('p.left', {
      for: 'website'
    }, 'website'), (0, _mithril.default)('p.right.bold', {
      name: 'website'
    }, website)])]);
  }
};

var makeItem = function makeItem(type) {
  switch (type) {
    case '/posts':
      return Post;
...
var Component = {
  view: function view(_ref8) {
    ...
    var route = model.state.route;
    var Item = makeItem(route);
    var data = model.data[route].data;
    return (0, _mithril.default)('section.component', {
      id: 'component',
      route: model.state.route,
      onscroll: (0, _index.infiniteScroll)(model)
    }, (0, _index.isEmpty)(data) ? (0, _mithril.default)('.loader', IsLoading) : data.map(function (_item, idx) {
      return (0, _mithril.default)(Item, {
        oncreate: (0, _index.animateComponentEntrance)(idx),
        key: idx,
        item: _item,
        model: model
      });
...
var toRoute = function toRoute(model) {
  return {
    onmatch: function onmatch(_, path) {
      return (0, _index.init)(model)(path);
    },
    render: function render() {
      return (0, _mithril.default)(_Layout.default, {
        model: model
      }, (0, _mithril.default)(Component, {
        model: model
      }));
    }
  };
...
exports.App = App;
},{"mithril":"node_modules/mithril/mithril.mjs","./components/Layout.js":"src/components/Layout.js","./utils/index.js":"src/utils/index.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/utils/animations.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/utils/loader.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
require("./utils/animations.css");

require("./utils/loader.css");
...
_mithril.default.route(root, '/posts', (0, _App.App)(_Model.model));
},{"mithril":"node_modules/mithril/mithril.mjs","./Model.js":"src/Model.js","./App.js":"src/App.js","./index.css":"src/index.css","./utils/animations.css":"src/utils/animations.css","./utils/loader.css":"src/utils/loader.css","./service-worker.js":[["src/service-worker.js","src/service-worker.js"],"src/service-worker.js.map","src/service-worker.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
